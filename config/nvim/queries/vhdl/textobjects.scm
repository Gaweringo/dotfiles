...
([(association_or_range_list) (association_list)]
  "," @parameter.outer
  .
  (association_element) @parameter.inner @parameter.outer)
([(association_or_range_list) (association_list)]
  .
  (association_element) @parameter.inner @parameter.outer
  .
...
(association_or_range_list (simple_range) @parameter.inner @param.outer)
...
(element_association_list
  "," @parameter.outer
  .
  (element_association) @parameter.inner @parameter.outer)
(element_association_list
  .
  (element_association) @parameter.inner @parameter.outer
  .
...
(sensitivity_specification (ALL) @parameter.inner @parameter.outer)

; Functions
(subprogram_definition) @function.outer
(process_statement) @function.outer
