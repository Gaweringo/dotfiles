...
function __fish_render_using_command
  set -l cmds __render __render_version __render_commands __render_config __render_config_init __render_config_add_profile __render_config_profiles __render_config_schema __render_regions __render_dashboard __render_docs __render_repo __render_repo_from_template __render_blueprint __render_blueprint_launch __render_blueprint_from_template __render_buildpack __render_buildpack_init __render_buildpack_remove __render_buildpack_add __render_services __render_services_show __render_services_list __render_services_tail __render_services_ssh __render_completions __render_completions_bash __render_completions_fish __render_completions_zsh __render_deploys __render_deploys_list __render_jobs __render_jobs_list __render_custom_domains __render_custom_domains_list
...
complete -c render -n '__fish_render_using_command __render' -s h -l help -k -f -d 'Shows help for this command.'
...
complete -c render -n '__fish_render_using_command __render_config' -k -f -a add-profile -d 'Adds a new profile to a Render CLI config file.'
complete -c render -n '__fish_render_using_command __render_config_add_profile' -k -f -a '(render completions complete string config add-profile)'
complete -c render -n '__fish_render_using_command __render_config_add_profile' -s v -l verbose -k -f -d 'Makes render-cli a lot more chatty.'
complete -c render -n '__fish_render_using_command __render_config_add_profile' -l non-interactive -k -f -d 'Forces Render to act as though it\'s not in a TTY.'
complete -c render -n '__fish_render_using_command __render_config_add_profile' -l pretty-json -k -f -d 'If in non-interactive mode, prints prettified JSON.'
complete -c render -n '__fish_render_using_command __render_config_add_profile' -l json-record-per-line -k -f -d 'if emitting JSON, prints each JSON record as a separate line of stdout.'
complete -c render -n '__fish_render_using_command __render_config_add_profile' -s p -l profile -k -f -r -a '(render completions complete string config add-profile)' -d 'The Render profile to use for this invocation. Overrides RENDERCLI_PROFILE.'
complete -c render -n '__fish_render_using_command __render_config_add_profile' -s r -l region -k -f -r -a '(render completions complete string config add-profile)' -d 'The Render region to use for this invocation; always accepted but not always relevant. Overrides RENDERCLI_REGION.'
complete -c render -n '__fish_render_using_command __render_config_add_profile' -s f -l force -k -f -d 'overwrites existing profile if found.'
complete -c render -n '__fish_render_using_command __render_config' -k -f -a profiles -d 'Lists your configured profiles.'
complete -c render -n '__fish_render_using_command __render_config_profiles' -s v -l verbose -k -f -d 'Makes render-cli a lot more chatty.'
complete -c render -n '__fish_render_using_command __render_config_profiles' -l non-interactive -k -f -d 'Forces Render to act as though it\'s not in a TTY.'
complete -c render -n '__fish_render_using_command __render_config_profiles' -l pretty-json -k -f -d 'If in non-interactive mode, prints prettified JSON.'
complete -c render -n '__fish_render_using_command __render_config_profiles' -l json-record-per-line -k -f -d 'if emitting JSON, prints each JSON record as a separate line of stdout.'
complete -c render -n '__fish_render_using_command __render_config_profiles' -s p -l profile -k -f -r -a '(render completions complete string config profiles)' -d 'The Render profile to use for this invocation. Overrides RENDERCLI_PROFILE.'
complete -c render -n '__fish_render_using_command __render_config_profiles' -s r -l region -k -f -r -a '(render completions complete string config profiles)' -d 'The Render region to use for this invocation; always accepted but not always relevant. Overrides RENDERCLI_REGION.'
...
complete -c render -n '__fish_render_using_command __render' -k -f -a dashboard -d 'Opens the Render dashboard in your browser.'
complete -c render -n '__fish_render_using_command __render_dashboard' -k -f -a '(render completions complete string dashboard)'
complete -c render -n '__fish_render_using_command __render_dashboard' -s v -l verbose -k -f -d 'Makes render-cli a lot more chatty.'
complete -c render -n '__fish_render_using_command __render_dashboard' -l non-interactive -k -f -d 'Forces Render to act as though it\'s not in a TTY.'
complete -c render -n '__fish_render_using_command __render_dashboard' -l pretty-json -k -f -d 'If in non-interactive mode, prints prettified JSON.'
complete -c render -n '__fish_render_using_command __render_dashboard' -l json-record-per-line -k -f -d 'if emitting JSON, prints each JSON record as a separate line of stdout.'
complete -c render -n '__fish_render_using_command __render_dashboard' -s p -l profile -k -f -r -a '(render completions complete string dashboard)' -d 'The Render profile to use for this invocation. Overrides RENDERCLI_PROFILE.'
complete -c render -n '__fish_render_using_command __render_dashboard' -s r -l region -k -f -r -a '(render completions complete string dashboard)' -d 'The Render region to use for this invocation; always accepted but not always relevant. Overrides RENDERCLI_REGION.'
complete -c render -n '__fish_render_using_command __render_dashboard' -s l -l link -k -f -d 'Prints out the Render Dashboard URL rather than attempting to open it.'
complete -c render -n '__fish_render_using_command __render' -k -f -a docs -d 'Opens the Render docs in your browser.'
complete -c render -n '__fish_render_using_command __render_docs' -k -f -a '(render completions complete string docs)'
complete -c render -n '__fish_render_using_command __render_docs' -s v -l verbose -k -f -d 'Makes render-cli a lot more chatty.'
complete -c render -n '__fish_render_using_command __render_docs' -l non-interactive -k -f -d 'Forces Render to act as though it\'s not in a TTY.'
complete -c render -n '__fish_render_using_command __render_docs' -l pretty-json -k -f -d 'If in non-interactive mode, prints prettified JSON.'
complete -c render -n '__fish_render_using_command __render_docs' -l json-record-per-line -k -f -d 'if emitting JSON, prints each JSON record as a separate line of stdout.'
complete -c render -n '__fish_render_using_command __render_docs' -s p -l profile -k -f -r -a '(render completions complete string docs)' -d 'The Render profile to use for this invocation. Overrides RENDERCLI_PROFILE.'
complete -c render -n '__fish_render_using_command __render_docs' -s r -l region -k -f -r -a '(render completions complete string docs)' -d 'The Render region to use for this invocation; always accepted but not always relevant. Overrides RENDERCLI_REGION.'
complete -c render -n '__fish_render_using_command __render_docs' -s l -l link -k -f -d 'Prints out the Render Docs URL rather than attempting to open it.'
...
complete -c render -n '__fish_render_using_command __render_blueprint' -k -f -a launch -d 'Opens Render Deploy for this repo.'
...
complete -c render -n '__fish_render_using_command __render_blueprint' -k -f -a from-template -d 'Adds a Render Blueprint (render.yaml) to this repo, based on a template.'
complete -c render -n '__fish_render_using_command __render_blueprint_from_template' -k -f -a '(render completions complete string blueprint from-template)'
complete -c render -n '__fish_render_using_command __render_blueprint_from_template' -s v -l verbose -k -f -d 'Makes render-cli a lot more chatty.'
complete -c render -n '__fish_render_using_command __render_blueprint_from_template' -l non-interactive -k -f -d 'Forces Render to act as though it\'s not in a TTY.'
complete -c render -n '__fish_render_using_command __render_blueprint_from_template' -l pretty-json -k -f -d 'If in non-interactive mode, prints prettified JSON.'
complete -c render -n '__fish_render_using_command __render_blueprint_from_template' -l json-record-per-line -k -f -d 'if emitting JSON, prints each JSON record as a separate line of stdout.'
complete -c render -n '__fish_render_using_command __render_blueprint_from_template' -s p -l profile -k -f -r -a '(render completions complete string blueprint from-template)' -d 'The Render profile to use for this invocation. Overrides RENDERCLI_PROFILE.'
complete -c render -n '__fish_render_using_command __render_blueprint_from_template' -s r -l region -k -f -r -a '(render completions complete string blueprint from-template)' -d 'The Render region to use for this invocation; always accepted but not always relevant. Overrides RENDERCLI_REGION.'
complete -c render -n '__fish_render_using_command __render_blueprint_from_template' -l directory -k -f -r -a '(render completions complete string blueprint from-template)' -d 'directory to write the blueprint to (default: current directory)'
complete -c render -n '__fish_render_using_command __render_blueprint_from_template' -l skip-cleanup -k -f -d 'skips cleaning up tmpdir (on success or failure)'
...
complete -c render -n '__fish_render_using_command __render_services_list' -l suspended -k -f -r -a '(render completions complete string services list)' -d '\'true\'/\'yes\', \'false\'/\'no\', or \'all\''
